...
public class VerificationCodeManager implements VerificationCodeService{
	...
	public DataResult<List<VerificationCode>> findAllByCode() {
		return new SuccessDataResult<List<VerificationCode>>(this.verificationCodeDao.findAll(),"Successfully listed");
	}
	...
	public Result activateUser(String activationCode) {
	    ...
	    verificationCodeDao.save(verificationCode);
	    return new SuccessResult("User activation has been performed.");
	}
